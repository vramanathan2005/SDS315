---
title: "HW 2"
author: "Varun Ramanathan, UT EID: vr23358"
date: "2024-01-28"
output: pdf_document
---
...
styled_table <- top_songs %>%
  kable(format = "latex", caption = "Top 10 Songs on Billboard with Their Counts") %>%
...
ggplot(unique_songs_per_year, aes(x = year, y = unique_songs)) + geom_line() + geom_point() + theme_minimal() + labs(title = "Musical Diversity in the Billboard Top 100 Over the Years", x = "Year", y = "Number of Unique Songs", caption = "Data Source: Billboard Top 100") + theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave("musical_diversity_over_years.png", width = 10, height = 6)
```
```{r, echo=FALSE}
...
ggplot(artist_hits, aes(x = reorder(performer, ten_week_hits), y = ten_week_hits)) + geom_bar(stat = "identity") + coord_flip() + labs(title = "Number of Ten-Week Hits by Artist in U.S. Musical History Since 1958", x = "Artist", y = "Number of Ten-Week Hits") + theme_minimal()
```
This plot shows artists who have achieved at least 30 'ten-week hits' (songs on the Billboard Top 100 for at least ten weeks) in their career since 1958.